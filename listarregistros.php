        ...
        <table class="table table-dark table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="registros.php?idregistro=<?php echo $r->idregistro ?>" class="btn btn-outline-warning">Editar</a></td>
                    <td><a href="registros.php?op=del&idregistro=<?php echo  $r->idregistro ?>" class="btn btn-outline-danger">Excluir</a></td>
